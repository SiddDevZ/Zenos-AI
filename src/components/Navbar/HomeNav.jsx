...
const Nav = () => {
  ...
  return (
    <nav className='fixed-nav max-w-[1440px] h-20 px-4 sm:px-20 md:px-24 lg:px-28 flex items-center justify-between animate-in'>
        ...
        <div>
            <Link className='inline-flex items-center justify-center whitespace-nowrap text-md font-medium text-btn transition-all duration-300 hover:scale-105 tspace' to="/chat">Chat</Link>
        </div>
    </nav>
  )
}
